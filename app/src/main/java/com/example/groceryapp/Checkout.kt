...
class Checkout : AppCompatActivity() {
    ...
    private fun writeOrder() {
        ...
        val info:String = "https://groceryapptarucproject.000webhostapp.com/grocery/order/insertorder.php?order_number=$order_number&payment_amount=$amount" + "&payment_method=$paymentMethod&delivery_address=${address.text}&user_id=$user_id&delivery_id=$delivery_id&payment_id=$payment_id&delivery_method=$deliveryMethod"
        Log.e("winnie",info)
